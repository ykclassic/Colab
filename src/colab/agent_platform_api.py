...
def register_agent_routes(app: Any) -> None:
    ...
    @app.post("/api/agents/registry", response_model=AgentRecord, status_code=201)
    ...
    @app.get("/api/agents/registry/{workspace_id}", response_model=list[AgentRecord])
    ...
    @app.post("/api/agents/memory/search", response_model=list[MemoryRecord])
