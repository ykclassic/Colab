...
const links = [
  ['Dashboard', '/'], ['Workflows', '/workflows'], ['Workspaces', '/workspaces'],
  ...
  ['Data Explorer', '/quant/data'], ['Live Trading', '/quant/live'], ['Research Reports', '/quant/reports'],
  ['Artifacts', '/artifacts'], ['Operations', '/operations'], ['Governance', '/governance'],
...
export function Nav() {
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-foot"><span className="status-dot" /> Platform online<br /><small>Phase 19 · agent platform</small></div>
    </aside>
  );
}
